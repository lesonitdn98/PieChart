...
public abstract class ComponentBase {
     ...
     */
    protected float mTextSize = Utils.Companion.convertDpToPixel(10f);
    ...
    public void setXOffset(float xOffset) {
        mXOffset = Utils.Companion.convertDpToPixel(xOffset);
    }
    ...
    public void setYOffset(float yOffset) {
        mYOffset = Utils.Companion.convertDpToPixel(yOffset);
    }
    ...
    public void setTextSize(float size) {
        ...
        mTextSize = Utils.Companion.convertDpToPixel(size);
    }
