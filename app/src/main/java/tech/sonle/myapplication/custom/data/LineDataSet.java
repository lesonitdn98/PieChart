...
import tech.sonle.myapplication.custom.formatter.DefaultFillFormatter;
import tech.sonle.myapplication.custom.formatter.IFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    public void setCircleRadius(float radius) {
        ...
        if (radius >= 1f) {
            mCircleRadius = Utils.Companion.convertDpToPixel(radius);
        } else {
    ...
    public void setCircleHoleRadius(float holeRadius) {
        ...
        if (holeRadius >= 0.5f) {
            mCircleHoleRadius = Utils.Companion.convertDpToPixel(holeRadius);
        } else {
