...
import tech.sonle.myapplication.custom.highlight.ChartHighlighter;
import tech.sonle.myapplication.custom.highlight.Highlight;
import tech.sonle.myapplication.custom.highlight.IHighlighter;
...
import tech.sonle.myapplication.custom.listener.ChartTouchListener;
import tech.sonle.myapplication.custom.listener.OnChartGestureListener;
import tech.sonle.myapplication.custom.listener.OnChartValueSelectedListener;
import tech.sonle.myapplication.custom.renderer.DataRenderer;
...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected void init() {
        ...
        mInfoPaint.setTextSize(Utils.Companion.convertDpToPixel(12f));
    ...
    protected void setupDefaultFormatter(float min, float max) {
        ...
        int digits = Utils.Companion.getDecimals(reference);
    ...
    public void setMaxHighlightDistance(float distDp) {
        mMaxHighlightDistance = Utils.Companion.convertDpToPixel(distDp);
    }
    ...
    public void setExtraTopOffset(float offset) {
        mExtraTopOffset = Utils.Companion.convertDpToPixel(offset);
    }
    ...
    public void setExtraRightOffset(float offset) {
        mExtraRightOffset = Utils.Companion.convertDpToPixel(offset);
    }
    ...
    public void setExtraBottomOffset(float offset) {
        mExtraBottomOffset = Utils.Companion.convertDpToPixel(offset);
    }
    ...
    public void setExtraLeftOffset(float offset) {
        mExtraLeftOffset = Utils.Companion.convertDpToPixel(offset);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = (int) Utils.Companion.convertDpToPixel(50f);
