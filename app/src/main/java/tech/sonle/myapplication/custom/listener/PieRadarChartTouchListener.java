...
package tech.sonle.myapplication.custom.listener;
...
import tech.sonle.myapplication.custom.PieRadarChartBase;
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mTouchMode == NONE
                            ...
                            > Utils.Companion.convertDpToPixel(8f)) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (mChart.isDragDecelerationEnabled()) {
                        ...
                        if (mDecelerationAngularVelocity != 0.f) {
                            ...
                            Utils.Companion.postInvalidateOnAnimation(mChart); // This causes computeScroll to fire, recommended for this by Google
                        }
                    }
