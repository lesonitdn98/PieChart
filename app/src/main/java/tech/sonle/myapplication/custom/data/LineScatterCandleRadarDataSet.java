...
import tech.sonle.myapplication.custom.interfaces.datasets.ILineScatterCandleRadarDataSet;
...
public abstract class LineScatterCandleRadarDataSet<T extends Entry> extends BarLineScatterCandleBubbleDataSet<T> implements ILineScatterCandleRadarDataSet<T> {
    ...
    public LineScatterCandleRadarDataSet(List<T> yVals, String label) {
        super(yVals, label);
        mHighlightLineWidth = Utils.Companion.convertDpToPixel(0.5f);
    }
    ...
    public void setHighlightLineWidth(float width) {
        mHighlightLineWidth = Utils.Companion.convertDpToPixel(width);
    }
