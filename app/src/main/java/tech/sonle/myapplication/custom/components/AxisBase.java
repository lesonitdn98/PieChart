...
import tech.sonle.myapplication.custom.formatter.DefaultAxisValueFormatter;
import tech.sonle.myapplication.custom.formatter.IAxisValueFormatter;
...
public abstract class AxisBase extends ComponentBase {
    ...
    public void setAxisLineWidth(float width) {
        mAxisLineWidth = Utils.Companion.convertDpToPixel(width);
    }
    ...
    public void setGridLineWidth(float width) {
        mGridLineWidth = Utils.Companion.convertDpToPixel(width);
    }
